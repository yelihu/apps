...
/**
 * HelloWorld服务测试类 - App2
 */
@Slf4j
@SpringBootTest
@ComponentScan(basePackages = {"com.example.app2", "com.example.common"})
public class HelloWorldServiceTest {
    ...
    public void testGetWelcomeMessage() {
        ...
        // 输出结果到控制台
        System.out.println("===============================");
        System.out.println("App2 - 欢迎消息: " + welcomeMessage);
        System.out.println("===============================");
    }
    ...
    public void testGreet() {
        ...
        // 输出结果到控制台
        System.out.println("===============================");
        System.out.println("App2 - 个性化问候: " + greetMessage);
        System.out.println("===============================");
    }
} 